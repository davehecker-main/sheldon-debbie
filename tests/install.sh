...
test -s "$tmp_dir/codex/agents/shareview-debbie.toml"
test -s "$tmp_dir/codex/agents/shareview-sheldon.toml"
test -s "$tmp_dir/claude/agents/shareview-debbie.md"
test -s "$tmp_dir/claude/agents/shareview-sheldon.md"
